...
#DATA_DIR <- system.file("C:/Users/TopKunG/Desktop/review_polarity/", package = "readtext")
setwd("C:/Users/TopKunG/Desktop/review_polarityreview_polarity/")

#Download all review
movie_review_pos <- as_tibble(readtext(paste0("txt_sentoken/pos/*")))
movie_review_neg <- as_tibble(readtext(paste0("txt_sentoken/neg/*")))
